...
interface ImportMetaEnv {
  ...
  readonly VITE_IDOLS_API_URL?: string;
  readonly VITE_IDOLS_API_URL_ALT?: string;
  readonly VITE_IDOLS_API_URLS?: string;
  readonly VITE_IDOLS_REMOTE_CONFIG_URL?: string;
  readonly VITE_IDOLS_GITHUB_REPO_SLUG?: string;
  readonly VITE_IDOLS_GITHUB_REPO?: string;
  readonly VITE_IDOLS_GITHUB_RELEASES?: string;
}
