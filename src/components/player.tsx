...
const Player_SEASON14 = () => {
  ...
  const discordAvatar = player?.Account.Discord?.AvatarUrl;

  const avatarImage = character?.Template
    ? `url(https://fortnite-api.com/images/cosmetics/br/${character.Template.replace(
        /_Retrac|_Idols/g,
        ""
      )}/icon.png)`
    : discordAvatar
